...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    const { fullname, lastname,email, password, repeatPassword, referralCode } = formData;
    // Basic validation
  

    try {
      const response = await Api.post('/register', { fullname,lastname, selectedDate,email, password, repeatPassword, referralCode });
