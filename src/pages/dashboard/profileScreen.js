...
function Account() {
  ...
  const [username, setUsername] = useState("sagartyagi");
    ...
    >
      ...
      <form className="flex flex-col gap-3">
        <div className="relative w-full">
          <i className="ph ph-user absolute inset-y-0 left-3 flex items-center text-white text-lg"></i>
...
{showPopupLogout && (
        ...
        >
          <div
            style={{ backgroundColor: "#202338", width: 425, height: 384, marginBottom: -39, borderTopLeftRadius: "38px",
              borderTopRightRadius: "38px" }}
            ...
            <div className="flex flex-col gap-3">
              ...
              <button
                style={{
                  ...
                  color: selectedButton === "no" ? "white" : "black",borderRadius:"28px"
