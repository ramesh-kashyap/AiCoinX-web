...
function Account() {
  ...
  return (
    <><Toaster position="top-center" /><div className="bg-[#0d0d0d] container bg-n900 min-h-dvh relative overflow-hidden flex justify-start items-start text-white pb-28">
    {/* Background Circle */}
